...
CREATE TABLE Fertirrega (id number(10) GENERATED AS IDENTITY, rega_id number(10) NOT NULL, aplicacao_fp_id number(10) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE LOG_OPERACAO (id number(10) GENERATED AS IDENTITY, operacao_id number(10) NOT NULL, log nvarchar2(255) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE Operacao_Agricola (id number(10) NOT NULL, data date NOT NULL, instante_registo timestamp(0) NOT NULL, validade number(10) NOT NULL, PRIMARY KEY (id));
...
ALTER TABLE Fertirrega ADD CONSTRAINT FKFertirrega922108 FOREIGN KEY (aplicacao_fp_id) REFERENCES Aplicacao_FP (operacao_id);
