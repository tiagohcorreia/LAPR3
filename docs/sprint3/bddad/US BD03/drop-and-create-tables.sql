...
CREATE TABLE Aplicacao_FP (Operacao_id number(10) NOT NULL, PRIMARY KEY (Operacao_id));
...
CREATE TABLE Fator_Producao (id number(10) NOT NULL, nome nvarchar2(255) NOT NULL, tipo_id number(10) NOT NULL, formulacao_id number(10) NOT NULL, ph float(10), densidade nvarchar2(255), PRIMARY KEY (id));
...
CREATE TABLE FP_APLICADOS (Operacao_id number(10) NOT NULL, fp_id number(10) NOT NULL, quantidade float(10), unidade nvarchar2(255), PRIMARY KEY (Operacao_id, fp_id));
...
CREATE TABLE Op_Plantacao (operacao_id number(10) NOT NULL, parcela_id number(10) NOT NULL, variedade_id number(10) NOT NULL, metodo_execucao_id number(10), quantidade float(10) NOT NULL, compasso float(10), distancia_filas float(10), PRIMARY KEY (operacao_id));
