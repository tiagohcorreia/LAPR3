CREATE TABLE Aplicacao_FP (operacao_id number(10) NOT NULL, parcela_id number(10) NOT NULL, variedade_id number(10), fator_producao_id number(10) NOT NULL, metodo_aplicacao_id number(10) NOT NULL, quantidade float(10) NOT NULL, area float(10), PRIMARY KEY (operacao_id));
...
CREATE TABLE SetorRega_Plantacao (id number(10) GENERATED AS IDENTITY, setor_id number(10) NOT NULL, plantacao_id number(10) NOT NULL, data_inicio date NOT NULL, data_fim date, PRIMARY KEY (id));
