...
public class Hub extends Local{
    ...
    public Hub(String localId, GPS gps, LocalTime openingHours, LocalTime closingHours, int dischargeTime) {
        ...
        this.numCollaborators = extractNumCollaborators(localId);
    }
    ...
    public void setNumCollaborators(int numCollaborators) {
    ...
    private int extractNumCollaborators(String localId) {
        String afterFirstTwoChars = localId.substring(2);
        return Integer.parseInt(afterFirstTwoChars);
    }
}
